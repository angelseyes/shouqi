 ...
 */
@Entity
@Table(name = "trace", catalog = "baic_obd")
@NamedQueries(value = { @NamedQuery(name = Trace.FIND_TRACE_BY_IMEI, query = "FROM Trace t WHERE t.imei = :imei") })
public class Trace implements java.io.Serializable {
	...
	public static final String FIND_TRACE_BY_IMEI = "findTraceByImei";
