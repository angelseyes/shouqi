Ext.define('BAICClassicApp.view.module.monitor.monitorveh.Window', {
    extend: 'Ext.window.Window',
    requires: ['BAICClassicApp.view.module.monitor.monitorveh.WindowController'],
    controller: {
        xclass: 'BAICClassicApp.view.module.monitor.monitorveh.WindowController'
    },
    items: [{
        xclass: 'Ext.ux.form',
        padding: 5,
