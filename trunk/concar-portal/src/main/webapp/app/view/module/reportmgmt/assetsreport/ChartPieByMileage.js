 ...
 */
Ext.define('BAICClassicApp.view.module.reportmgmt.assetsreport.ChartPieByMileage', {
    ...
    items: [{
        xtype: 'polar',
        reference: 'chartpiebymileage',
        insetPadding: 10,
        innerPadding: 20,

        bind: {
            store: '{myChartPieByMileageStore}'
        },
        legend: {
            docked: 'right'
        },
        ...
        series: [{
            ...
            tooltip: {
                trackMouse: true,
                renderer: 'onMileageSeriesTooltipRender'
            }
        }]
    }],
