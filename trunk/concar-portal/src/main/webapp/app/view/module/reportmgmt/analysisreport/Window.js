Ext.define('BAICClassicApp.view.module.reportmgmt.analysisreport.Window', {
    extend: 'Ext.window.Window',
    requires: ['BAICClassicApp.view.module.reportmgmt.analysisreport.WindowController'],
    controller: {
        xclass: 'BAICClassicApp.view.module.reportmgmt.analysisreport.WindowController'
    },
    items: [{
        xclass: 'Ext.ux.form',
        padding: 5,
