Ext.define('BAICClassicApp.view.module.reportmgmt.assetsreport.Window', {
    extend: 'Ext.window.Window',
    requires: ['BAICClassicApp.view.module.reportmgmt.assetsreport.WindowController'],
    controller: {
        xclass: 'BAICClassicApp.view.module.reportmgmt.assetsreport.WindowController'
    },
    items: [{
        xclass: 'Ext.ux.form',
        padding: 5,
