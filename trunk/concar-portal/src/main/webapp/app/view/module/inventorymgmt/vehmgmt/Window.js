Ext.define('BAICClassicApp.view.module.inventorymgmt.vehmgmt.Window', {
    extend: 'Ext.window.Window',
    requires: ['BAICClassicApp.view.module.inventorymgmt.vehmgmt.WindowController'],
    controller: {
        xclass: 'BAICClassicApp.view.module.inventorymgmt.vehmgmt.WindowController'
    },
    items: [{
        xclass: 'Ext.ux.form',
        padding: 5,
