Ext.define('BAICClassicApp.view.module.fullmapdisplay.GridTrack', {
    ...
    store: {
        ...
        listeners: {
            load: function(it, records, successful, eOpts) {
                ...
                delayedTask.delay(1000, function(args) {
                ...
                var updateClock = function() {
                    ...
                    trackMapWindow.setTitle(' 车辆TRACK-' + trackMapWindow.getViewModel().selectedRecord.data.plateNumber + '-窗口将在' + ss + '秒后刷新');
                    if (ss == 0) {
            ...
            beforeload: function(store, operation, eOpts) {
                store.proxy.extraParams = {
                    'imei': Ext.ComponentQuery.query('#windowTrackmap')[0].getViewModel().selectedRecord.data.imei
                }
            }
