Ext.define('BAICClassicApp.view.module.inventorymgmt.obdmgmt.Window', {
    extend: 'Ext.window.Window',
    requires: ['BAICClassicApp.view.module.inventorymgmt.obdmgmt.WindowController'],
    controller: {
        xclass: 'BAICClassicApp.view.module.inventorymgmt.obdmgmt.WindowController'
    },
    items: [{
        xclass: 'Ext.ux.form',
        padding: 5,
