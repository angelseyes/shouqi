 ...
 */
Ext.define('BAICClassicApp.view.module.reportmgmt.assetsreport.ChartPieByInstitution', {
    ...
    items: [{
        xtype: 'polar',
        reference: 'chartpiebyinstitution',
        insetPadding: 10,
        innerPadding: 20,

        bind: {
            store: '{myChartPieByInstitutionStore}'
        },
        legend: {
            docked: 'right'
        },
        ...
        series: [{
            ...
            tooltip: {
                trackMouse: true,
                renderer: 'onInstitutionSeriesTooltipRender'
            }
        }]
    }],
