...
*/
Ext.define('CRental.ux.TreeCombo', {
    ...
    canSelectFolders: true,
    multiselect: false,
    editable: false, //False to prevent the user from typing text directly into the field; 
    displayField: 'text',
    valueField: 'id',
    treeWidth: 300,
    ...
    setValue: function(valueInit) {
    	//解决gps列表，编辑单位为空的item引发的问题
        if (typeof valueInit == 'undefined' || valueInit == null) return;
        //解决load一个设定好的值错误问题
