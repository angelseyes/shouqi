Ext.define('BAICClassicApp.ux.map.MapPanel', {
    ...
    initComponent: function() {
        ...
        BAICClassicApp.ux.map.MapPanel.superclass.initComponent.call(this);
    },
    ...
    afterRender: function() {
        ...
        me.bmap.centerAndZoom('武汉', 5);
        //设置中心位置
        me.getLocation();
        //地图加载完成后加载控件和菜单
        me.bmap.addEventListener("tilesloaded", me.onMapReady());
        BAICClassicApp.ux.map.MapPanel.superclass.afterRender.call(me);
    },
    getMap: function() {
        return this.bmap;
    },
