package cn.concar.gw.listener.util;
...
public class PropertiesLoader {    /**
    ...
    private static final String PROP_NAME = "concar-gw-listener.properties";
    /**
    ...
    public static synchronized String getAppProperty(final String name) {
        Properties p = cache.get(PROP_NAME);
        if(p == null) {
            String ploc = PROP_NAME;
            p = new Properties();
            try {
