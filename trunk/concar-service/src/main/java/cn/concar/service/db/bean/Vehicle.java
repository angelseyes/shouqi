 ...
 */
@Entity
@Table(name = "vehicle", catalog = "baic_vs")
public class Vehicle implements java.io.Serializable {
	...
	public Vehicle(String plateNumber, String vin, String model, String displacement, String color, Double mileage,
			...
			Date insuranceDate, Date inspectionDate, Boolean violation, String imei, Long belongDepartment) {
	...
	@Column(name = "displacement", length = 45)
